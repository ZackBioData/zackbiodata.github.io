...
Detects clusters of varients which are 

    - regions that are functionally critical (splice sites, key protein domains),

    - regions that are mutationally “hot” (CpG, ssDNA exposure, repeats),

    - genes that are clinically important / heavily tested.
---
...
Same query, same clustering, same exports on a different clinvar data set just change table name as all the columns are the same throughout all sets.
